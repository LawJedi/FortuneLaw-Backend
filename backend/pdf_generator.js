...
console.log("data",data)
  ...
  const $ = {
    ...
    pageNumber: function(){
      let sfsize = doc.getFontSize(), sfcolor = doc.getTextColor();
  ...
  function footer(){
   ...
   doc.addImage($.img("working1_2", "png"), 14, 234, 180, 38.25)
   $.pageNumber()
 
 
   doc.addPage()
   $.pageNumber()
   doc.addImage($.img("working2_1", "png"), 15, 25, 180, 142.1);
   doc.addImage($.img("working2_2", "png"), 16, 165, 180, 100);
    ...
    didParseCell: function(cellData){
      if(cellData.section !== "head"){
        switch(cellData.column.index){
          ...
          case 3:
          case 6: 
          case 7: cellData.cell.text = formatter.money(cellData.cell.text);break;
          case 2: {
            if(isNaN(parseFloat(cellData.cell.text.join("")))) break;
            cellData.cell.text = formatter.percent(cellData.cell.text);
            break;
